 ...
 */
public class GreeterClientExtended {
  private static final Logger logger = Logger.getLogger(GreeterClientExtended.class.getName());
  ...
  public GreeterClientExtended(String[] args) {
    ...
    ManagedChannelBuilder builder = ManagedChannelBuilder.forAddress(hostPort[0], Integer.parseInt(hostPort[1]))
  ...
  public static void main(String[] args) throws Exception {
    new GreeterClientExtended(args).doMain();
  }
